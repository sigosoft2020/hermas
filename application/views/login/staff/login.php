                            ...
                            <div class="account-pages">
                                <div class="account-box">
                                    <div class="account-logo-box">
                                        ...
                                        <h6 class="text-uppercase text-center font-bold mt-4">staff login</h6>
                                    </div>
                                    <div class="account-content">
                                        <form class="form-horizontal" method="post" action="<?=site_url('users/staffLogin')?>">

                                            <div class="form-group m-b-20 row">
                                                <div class="col-12">
                                                    <label for="emailaddress">Email address / Mobile number</label>
