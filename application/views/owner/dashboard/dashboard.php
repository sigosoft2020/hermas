...
<html>
    <head>
      <?php $this->load->view('owner/includes/includes'); ?>
      <style media="screen">
        .button {
          color: black;
          padding: 20px;
    ...
    <body>
        <div id="wrapper">
            <?php $this->load->view('owner/includes/sidebar'); ?>
            ...
            <div class="content-page">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                                <a style="text-decoration:none;color:#797979;" href="<?=site_url('owner/bookings/upcoming')?>"><div class="card-box tilebox-one">
                            ...
                            <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                                <a style="text-decoration:none;color:#797979;" href="<?=site_url('owner/turfs')?>"><div class="card-box tilebox-one">
                            ...
                            <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                                <a style="text-decoration:none;color:#797979;" href="<?=site_url('owner/expenses')?>"><div class="card-box tilebox-one">
                            ...
                            <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    <i class="fi-briefcase float-right"></i>
                                    <h6 class="text-muted text-uppercase mb-3">Online transactions this month</h6>
                                    <h4 class="mb-3" data-plugin="counterup">₹ <?=$online?></h4>
                                    <!-- <span class="badge badge-primary"> +89% </span> <span class="text-muted ml-2 vertical-middle">Last year</span> -->
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    <i class="fi-briefcase float-right"></i>
                                    <h6 class="text-muted text-uppercase mb-3">Other transactions this month</h6>
                                    <h4 class="mb-3" data-plugin="counterup">₹ <?=$offline?></h4>
                                    <!-- <span class="badge badge-primary"> +89% </span> <span class="text-muted ml-2 vertical-middle">Last year</span> -->
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="comment-list slimscroll" style="max-height: 370px;">
                                      <?php foreach ($feedbacks as $feedback) { ?>
                                        ...
                                        <a href="<?=site_url('owner/feedbacks')?>">
                                ...
                                <div class="card-box">
                                    ...
                                    <ul class="list-unstyled transaction-list slimscroll mb-0" style="max-height: 370px;">
                                      <?php foreach ($expenses as $exp) { ?>
                                        ...
                                        <a style="color:#797979;" href="<?=site_url('owner/expenses')?>"><li>
                ...
                <?php $this->load->view('owner/includes/footer') ?>
        ...
        <?php $this->load->view('owner/includes/scripts') ?>
        <script type="text/javascript">
          ...
          $('#turf').on('change',function(){
            ...
            if (turf_id == 0) {
              ...
              $.ajax({
                method: "POST",
                url: "<?=site_url('owner/dashboard/getDates');?>",
                dataType : "json",
          ...
          function getPitches(id)
          {
            ...
            $.ajax({
              method: "POST",
              url: "<?=site_url('owner/dashboard/getPitches');?>",
          ...
          function getSlots(id){
            ...
            $.ajax({
              method: "POST",
              url: "<?=site_url('owner/dashboard/getTimeSlots');?>",
