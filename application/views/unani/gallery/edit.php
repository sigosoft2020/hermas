      ...
      <div class="content-page">
        <div class="content">
            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box">
                  <h4 class="page-title float-left">EDIT GALLERY IMAGE</h4>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box">
                <form action="<?=site_url('unani/gallery/editGallery')?>" method="post" id="add-form">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" maxlength="200" placeholder="Enter title here" name="title" value="<?=$gallery->name?>" class="form-control" required>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Description <span style="color:red">*</span></label>
                        <textarea name="description" placeholder="Enter gallery here" class="form-control" rows="5" cols="80"><?=$gallery->description?></textarea>
                      </div>
                    </div>
                    ...
                    <div class="col-md-12">
                      <div id="current-image">
                        <img src="<?=base_url() . $gallery->image?>" width="100%">
                      </div>
