      ...
      <div class="content-page">
        <div class="content">
            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box">
                  <h4 class="page-title float-left">ADD GALLERY IMAGES</h4>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box">
                <form action="<?=site_url('unani/gallery/addGallery')?>" method="post" id="add-form">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea name="description" placeholder="Enter gallery here" class="form-control" rows="5" cols="80"></textarea>
                      </div>
                    </div>
