...
<html>
  ...
  <body>
    <div id="wrapper">
      ...
      <div id="add-salesman" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
          <div class="modal-dialog">
              <div class="modal-content">

                  <div class="modal-body">
                      <h2 class="text-uppercase text-center m-b-30">
                          <span><h4>Add Salesman</h4></span>
                      </h2>
                      <form class="form-horizontal" action="<?=site_url('admin/salesman/addSalesman')?>" method="post">
                          <div class="form-group m-b-25">
                              <div class="col-12">
                                  <label for="select">Salesman Name</label>
                                  <input type="text" name="name" id="name" class="form-control" maxlength="100" placeholder="Name" required>
                              </div>
                          </div>
