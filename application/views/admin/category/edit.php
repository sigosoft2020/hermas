                  ...
                  <div class="row">
                      <div class="col-md-5">
                          <div class="">
                              <div>
                                  ...
                                  <input type="text" maxlength="25" name="name" class="form-control" value="<?=$category->category_name?>" required>
                              </div>
                      ...
                      <div class="col-md-7">
                        <div id="current-image">
                          <img src="<?=base_url() . $category->CategoryImage?>" height="250px" width="450px">
                        </div>
