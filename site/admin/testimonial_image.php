...
if(isset($_POST['submit']))
{
    ...
    $update="UPDATE testimonial SET image='$image' WHERE id='$test_Id'";
    ...
    echo "<script> alert('Upload Error');window.location.href = 'manage_testimonial.php';</script>";
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" method="POST"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" >
                       ...
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image">Testimonial Image <span class="required">(600*600 pixel)</span>
                        </label>
