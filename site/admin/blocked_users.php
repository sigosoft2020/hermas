                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['phone']; ?></td>
                           ...
                           <td><a href="user_unblock.php?id=<?php echo $row['user_id']; ?>" onclick="return confirm('Are you sure?')"><button type="button" class="btn btn-primary btn-xs black-background white">UnBlock</button></a> | <a href="delete_user.php?id=<?php echo $row['user_id']; ?>" onclick="return confirm('Are you sure?')"><button type="button" class="btn btn-primary btn-xs delete-background delete">Delete</button></a></td>  
