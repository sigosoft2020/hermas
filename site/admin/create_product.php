...
if($b2b=='')
{
  $b2b_price=$price-($price*$percentage/100);
}
else
{
 $b2b_price = $b2b;
...
$file4 = $_FILES['file-4'];
    ...
    if(move_uploaded_file($_FILES["image"]["tmp_name"], $target))
    {
     ...
     $query="INSERT INTO products(product_name, product_description, image, category_id, quantity, price, status, featured,indication,b2b_percentage,b2b_price) VALUES ('$product_name', '$product_description', '$image', '$category_id', '$quantity', '$price', 'Active', 'Product','$indication','$percentage','$b2b_price')";
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <!-- <input id="price" class="form-control selectpicker col-md-7 col-xs-12" data-live-search="true" data-validate-length-range="6" data-validate-words="2" name="b2b_percentage" id="b2b_percentage" placeholder="B2B Percentage" required="required" type="text" > -->
                           <input type="number" class="form-control selectpicker col-md-7 col-xs-12" data-live-search="true" data-validate-length-range="6" data-validate-words="2" name="b2b_percentage" id="b2b_percentage"  >
                        </div>
                      </div>
                     ...
                     <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <!--  <input id="price" class="form-control selectpicker col-md-7 col-xs-12" data-live-search="true" data-validate-length-range="6" data-validate-words="2" name="b2b_price" id="b2b_price" placeholder="B2B Price" required="required" type="text" > -->
                          <input type="number" class="form-control selectpicker col-md-7 col-xs-12" data-live-search="true"  data-validate-length-range="6" data-validate-words="2" name="b2b_price" id="b2b_price"  >
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="file-4" name="file-4"  class="form-control col-md-7 col-xs-12" onchange="preview_image(this)">
                        </div>
                      </div>
