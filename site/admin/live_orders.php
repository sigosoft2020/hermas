...
if(isset($_POST['update']))
{
  ...
  if (mysqli_query($conn, $update))
  {
    ...
    echo "<script> alert('Modification Successfully');window.location.href = 'live_orders.php';</script>";
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['status']; ?></td>
                           ...
                           <td><a href="view_orders.php?id=<?php echo $row['order_id'];?>">View</a></td>  
                           <td><input type="submit" name="update" value="Update" class="btn btn-primary btn-xs black-background white"  onclick="updater('<?php echo $row['order_id']; ?>')" data-toggle="modal" data-target="#myModal"></td>  
