...
<html lang="en">
  <head>
    ...
    <title>Calicut Fish | Admin </title>
 ...
 <?php require 'partials/sidebar.php'; ?>
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" minlength=6 class="form-control col-md-7 col-xs-12" name="password" placeholder="Password" required="required" >
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" minlength=6 class="form-control col-md-7 col-xs-12" name="confirm_password" placeholder="Confirm Password" required="required">
                        </div>
                      </div>
        ...
        <footer>
          <div class="pull-right">
             Powered By <a href="">Calicut Fish</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
